...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput+'" placeholder="表格的各个属性值"  style="width:230px;"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "显示第 _START_ 条到第 _END_ 条，共 _TOTAL_ 条记录",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "显示第 0 条到第 0 条，共 0 条记录",
			 ...
			 *    } );
			 */
			"sSearch": "<b style='font-size:14px;'>关键字查询:</b>",
