		...
		<div class="main_box">
			<div class="login_box">
				<div class="login_logo">
					<label for="j_title" class="tt">电子商务平台测试 <!-- <img src="assets/images/logo.png"> -->
				</div>
				<div class="login_form">
					<form action="form.html" id="login_form" method="post">
						<div class="form-group">
							<label for="login-name" class="t">登录名：</label> 
							<input id="login-name" value="" name="email" type="text" class="form-control x319 in" placeholder="请输入登录名" />
						</div>
						<div class="form-group">
							<label for="login-pass" class="t">密&nbsp;&nbsp;&nbsp;&nbsp;码：</label> 
							<input id="login-pass" value="" name="password" type="password" class="password form-control x319 in" placeholder="请输入密码" />
						</div>
						<div class="form-group">
