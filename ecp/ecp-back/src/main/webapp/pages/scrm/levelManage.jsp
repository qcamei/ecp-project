...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
									...
									<div class="table-responsive"
										...
										<div id="dataTables-example_wrapper"
											...
											<div id="item-div" style="margin: 20px">
												<%@ include file="levelManageTable.jsp" %>
											</div>
										...
										<div class="modal-content animated fadeIn">
											...
											<div class="modal-body">
												<form class="form-horizontal" id="save-form">
													<input type="hidden" id="level-id" name="levelId" value="" />
													<div class="form-group">
														<label class="col-sm-2 control-label">等级名称</label>
														<div class="col-sm-10">
															<input type="text" id="level-name" name="levelName" class="form-control">
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-10">
															<input type="text" id="level-des" name="levelDes" class="form-control">
														</div>
													</div>
													<div class="form-group">
		...
		<script type="text/javascript" src="static/js/levelManage.js"></script>
