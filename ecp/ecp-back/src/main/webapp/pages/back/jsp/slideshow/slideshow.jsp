					...
					<div class="tabs-container" id="tabs-243687">
						<ul class="nav nav-tabs" id="top_tab">
							<li class="active" onclick="javascript:resetFun();"><a data-toggle="tab" href="#tab-1"
								aria-expanded="true">轮播图列表</a></li>
							<li class="hide" id="edit-slideshow-li"><a
									...
									<div class="row clearfix">
										<div class="col-md-12 column">
											<div class="panel panel-default">
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<button type="button" class="btn btn-default btn-primary" id="add-slideshow-btn">添加轮播图</button>
													</div>
												</div>
												<div class="panel panel-default">
													<div class="panel-body">
														<div id="item-div" style="margin: 20px">
															<%@ include file="slideshow_table.jsp"%>
														</div>
													</div>
												</div>
												</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													<form class="form-horizontal" id="save-form">
														<input type="hidden" id="slideshow-id" name="id" value="" />
														<div class="form-group">
															<label class="col-sm-2 control-label">名称<b style="color:red;">&nbsp;*</b></label>
															<div class="col-sm-10">
																<input type="text" id="slideshow-title" name="title"
																	class="form-control" placeholder="名称" />
															</div>
														</div>
														<div class="form-group">
															<label class="col-md-2 control-label">轮播图<b style="color:red;">&nbsp;*</b></label>
															<div class="col-md-5 ">
																<input type="file" id="slideshow-file" name="slideshow"
																	onchange="javascript:validateImgFileSizeFun(this);"
																	accept="image/*" /> 
																	<input type="hidden" id="slideshow-img-url" name="imgUrl" />
															</div>
															<!-- <div class="col-md-5">
														...
														<div class="form-group">
															...
															<div class="col-sm-10" id="slideshow-img-portrait"></div>
														</div>
														<div class="form-group" id="slideshow-type">
															<label for="name" class="col-sm-2 control-label">类型<b style="color:red;">&nbsp;*</b></label>
															<div class="col-sm-3">
																<label onclick="javascript:selectType(1);"><input type="radio" name="type" value="1" checked="checked" />&nbsp;&nbsp;商品</label>
															</div>
															<div class="col-sm-3">
																<label onclick="javascript:selectType(2);"><input type="radio" name="type" value="2" />&nbsp;&nbsp;类目</label>
															</div>
														</div>
														<div class="form-group" id="slideshow-showed">
														...
														<div class="form-group">
															...
															<div class="col-sm-5">
																<input type="text" class="form-control" id="slideshow-url" name="url" value="" placeholder="链接" readonly="readonly" />
															</div>
															<div class="col-sm-5" id="slideshow-item">
																<button type="button" class="btn btn-primary" title="选择商品" id="selected-item-btn" onclick="javascript:openItemDialog();">选择商品&nbsp;&nbsp;&nbsp;》</button>
															</div>
															<div class="col-sm-5 hide" id="slideshow-category">
