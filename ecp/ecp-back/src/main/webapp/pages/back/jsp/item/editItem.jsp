...
<div class="tabs-container" id="tabs-edit-item">
		<ul class="nav nav-tabs" id="top_tab">
			<li class="active"><a
				data-toggle="tab" href="#tab-5" aria-expanded="false">商品基本信息</a></li>
			<li class=""><a
				data-toggle="tab" href="#tab-6" aria-expanded="false">商品图片</a></li>
			<li class=""><a
				data-toggle="tab" href="#tab-7" aria-expanded="false">属性和SKU</a></li>
		</ul>
